...
levels_sigma = [25, 25.25, 25.5, 25.75, 26, 26.25, 26.5, 26.75, 27, 27.25, 27.5, 27.75]
levels_sigma_negrita = [27]
...
CS = ax1.contour(x[:300, :], p[:300, :], data_sigma[:300, :], levels_sigma, colors='white', linewidths=1.5, linestyles='dashed', zorder=6)
CS = ax1.contour(x[:300, :], p[:300, :], data_sigma[:300, :], levels_sigma_negrita, colors='white', linewidths=3, linestyles='dashed', zorder=6)
...
CS = ax2.contour(x[300:, :], p[300:, :], data_sigma[300:, :], levels_sigma, colors='white', linewidths=1.5, linestyles='dashed', zorder=6)
CS = ax2.contour(x[300:, :], p[300:, :], data_sigma[300:, :], levels_sigma_negrita, colors='white', linewidths=3, linestyles='dashed', zorder=6)
